...
namespace mantra
{
    ...
    int CaptureFrame(void *device, int width, int height, unsigned char *FinalFrame, unsigned char *bitmapdata, unsigned char *Iso_19794_2_Template, unsigned char *Ansi_378_2004_Template, int *ISOTemplateLength, Napi::Env env, Napi::Function &emit)
    {
        ...
        Napi::Object progressObject = Napi::Object::New(env);
    ...
    void IdentifyFromTemplates(struct MatchResult *currentMatch, Napi::Env &env, Napi::Function &emit)
    {
        ...
        emit.Call({Napi::String::New(env, "finger_identification"), Napi::String::New(env, "STARTING FINGER SCAN")});

        // printf("\nPlace finger and press any key and enter to capture first frame\n");
        // getkey();

        // printf("\nPlace finger and press enter to capture first frame\n");
        ret = CaptureFrame(device, width, height, FinalFrame1, BitmapData1, Iso_19794_2_Template1, Ansi_378_2004_Template1, &ISOTemplateLength1, env, emit);
        if (ret != 0)
        {
            PrintErrorMsg(ret);
        }
    ...
    Napi::Object getDeviceInfo(const Napi::CallbackInfo &info)
    {
        ...
        // obj.set(Napi::String::New(env, "serial"),Napi::String::New(env, ) );
        obj.Set(Napi::String::New(env, "make"), Napi::String::New(env, Make));
        obj.Set(Napi::String::New(env, "model"), Napi::String::New(env, Model));
    ...
    Napi::Object Init(Napi::Env env, Napi::Object exports)
    {
        ...
        exports.Set(Napi::String::New(env, "identifySpecial"), Napi::Function::New(env, IdentifySpecial));
